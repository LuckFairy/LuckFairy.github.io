...
顺便一提自己也写了一遍 [Start mobile front end](http://LuckFairy.github.io/frontend/2015/12/15/start-mobile-front-end.html) 的博客，有兴趣的可以先读一读。而规范使用的模板可以 [html5-boilerplate](https://github.com/bear-front-end/html5-boilerplate) 找到。
...
进行手机端开发的时候硬性要求。可以看看我的博客 [Start mobile front end](http://LuckFairy.github.io/frontend/2015/12/15/start-mobile-front-end.html) 里面提到的 [web app变革之rem](http://isux.tencent.com/web-app-rem.html) 进行学习。
